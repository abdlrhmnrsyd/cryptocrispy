...
export default function AppSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bottom-0 w-[220px] bg-white dark:bg-[#070A11] border-r border-slate-200 dark:border-slate-800/80 z-50 flex flex-col justify-between transition-all duration-200 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
            <button className="p-1.5 rounded-lg bg-slate-100 dark:bg-[#0D1117] border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
              <ArrowLeft className="w-4 h-4" />
            </button>

            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/50 text-[10px] font-medium text-blue-600 dark:text-blue-400">
              ...
              return (
                <NavLink
                  ...
                  className={`flex items-center justify-between px-3 py-2.5 rounded-xl font-semibold transition-all ${
                    isActive
                      ? 'bg-blue-50 dark:bg-[#131B26] text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-500/30 shadow-xs'
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
          <button
            ...
            className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors w-full px-2 py-1.5"
          >
